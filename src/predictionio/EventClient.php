<?php
    ...
    class EventClient extends BaseClient {
         ...
         */
        public function setUser($uid, array $properties = [], $eventTime = null): array {
         ...
         * @throws PredictionIOAPIError Request error
         */
        public function unsetUser($uid, array $properties, $eventTime = null): array {
            $eventTime = $this->getEventTime($eventTime);
            if (empty($properties))
         ...
         * @throws PredictionIOAPIError Request error
         */
        public function deleteUser($uid, $eventTime = null): array {
            $eventTime = $this->getEventTime($eventTime);
         ...
         * @throws PredictionIOAPIError Request error
         */
        public function setItem($iid, array $properties = [], $eventTime = null): array {
            $eventTime = $this->getEventTime($eventTime);
            if (empty($properties)) $properties = (object)$properties;
            $json = json_encode([
                'event'      => '$set',
         ...
         * @throws PredictionIOAPIError Request error
         */
        public function unsetItem($iid, array $properties, $eventTime = null): array {
            $eventTime = $this->getEventTime($eventTime);
            if (empty($properties))
                throw new PredictionIOAPIError('Specify at least one property');
            $json = json_encode([
         ...
         * @throws PredictionIOAPIError Request error
         */
        public function deleteItem($iid, $eventTime = null): array {
            $eventTime = $this->getEventTime($eventTime);
         ...
         * @throws PredictionIOAPIError Request error
         */
        public function listEvents(int $limit=20): array {
            return $this->sendRequest('GET',
                "/events.json?accessKey=$this->accessKey&limit=$limit", '');
        }
    }
